...
<body>
    ...
    <section class="blog-hero">
        <h1>Wedding Highlight | Vimitha & Gokulan</h1>
    ...
    <main class="blog-details-main">
        ...
        <article class="blog-content">
            <img src="./Assets/images/wed.jpg" alt="Wedding of Vimitha & Gokulan" class="main-blog-img" />
            <p>
                Every moment is a memory – watch how we brought their special day to life with cinematic visuals and creative
                storytelling. We captured real emotions, joy, and timeless elegance.
            </p>
            <p>
                The wedding of Vimitha and Gokulan was a beautiful blend of tradition and modernity. From the intricate details
                of the ceremony to the heartfelt moments shared between the couple, every aspect was meticulously planned and
                executed.
            </p>
            <p>
                Our team focused on capturing the essence of their love story, highlighting the candid moments that often go
                unnoticed. The laughter, the tears, and the unspoken words were all woven together to create a narrative that
                truly represents their journey.
            </p>
            <h2 class="blog-subheading">✨ Behind the Scenes Magic</h2>

            <p>
                Our team used state-of-the-art cameras, drones, and lighting setups to ensure every shot was magical. From the
            ...
            <p>
                ...
                celebration. Our lighting setups ensured that every frame was picture-perfect, highlighting the emotions and
                ambiance of the event.
            </p>
            <p>
                Collaborating closely with Vimitha and Gokulan, we ensured that their vision was brought to life. Their input
                was invaluable in creating a wedding film that they will cherish for years to come.
            </p>
        </article>
    ...
    <nav class="bottom-nav">
        <a href="{{ route('blog') }}" class="nav-item active" data-page="blog">
