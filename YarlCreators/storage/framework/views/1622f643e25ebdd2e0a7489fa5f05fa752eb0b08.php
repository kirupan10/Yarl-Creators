...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/videoBanner.css')); ?>">
    ...
    <link rel="stylesheet" href=" <?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css')); ?> ">
    <script defer src=" <?php echo e(asset('Js/script.js')); ?>"></script>
    <script defer src="<?php echo e(asset('Js/faq.js')); ?>"></script>
</head>
    ...
    <section class="hero">
        <div class="top-icons">
            ...
            <?php if(Auth::check()): ?>
                ...
                <a href="<?php echo e(route('profile')); ?>" class="icon login"><i class="fas fa-user"></i></a>
                <a href="<?php echo e(route('logout')); ?>" class="icon logout"><i class="fas fa-sign-out-alt"></i></a>
            <?php else: ?>
                <!-- User is not logged in, show login icon -->
                <a href="<?php echo e(route('login')); ?>" class="icon login"><i class="fas fa-sign-in-alt"></i></a>
            <?php endif; ?>

        </div>

        <div class="logo">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Yarl Creators Logo">
        </div>
        <div class="hero-text">
...
>>>>>>> Stashed changes
    ...
    <nav class="bottom-nav">
        <a href="<?php echo e(route('gallery')); ?>" class="nav-item" data-page="gallery">
            <i class="fas fa-images"></i>
            <span>Gallery</span>
        </a>
        <a href="<?php echo e(route('products')); ?>" class="nav-item" data-page="shop">
        ...
        <a href="<?php echo e(route('service')); ?>" class="nav-item" data-page="services">
            <i class="fas fa-concierge-bell"></i>
            <span>Services</span>
        </a>
        <a href="<?php echo e(route('contact')); ?>" class="nav-item" data-page="contact">
...
<?php /**PATH C:\Users\mhdsh\OneDrive\Documents\GitHub\Yarl-Creators\YarlCreators\resources\views/layout.blade.php ENDPATH**/ ?>