    ...
    <body>
        ...
        <section class="featured-products">
            ...
            <div class="product-container">
                ...
                <div class="product-card">
                    <img src="<?php echo e(asset('images/Acc.jpg')); ?>" alt="Camera Accessory">
                    <div class="product-info">
                        <h3>Camera Accessories</h3>
                        <p>Essential accessories to enhance photography.</p>
                        <button class="product-btn" onclick="window.location='<?php echo e(route('CameraAccessories')); ?>'" style="text-decoration: none;">Shop Now</button>
                    </div>
                </div>

                <!-- Product 2 -->
                <div class="product-card">
                    <img src=" <?php echo e(asset('images/pai.jpg')); ?>" alt="Painting Frame">
                    <div class="product-info">
                        <h3>Painting Frames</h3>
                        <p>Beautiful custom painting frames perfect for your artworks.</p>
                        <button class="product-btn" onclick="window.location='<?php echo e(route('PaintingFrames')); ?>'" style="text-decoration: none;">Shop Now</button>
                    </div>
                </div>

                <!-- Product 3 -->
                <div class="product-card">
                    <img src="<?php echo e(asset('images/Skt.jpg')); ?>" alt="Sketches">
                    <div class="product-info">
                        <h3>Sketches</h3>
                        <p>Hand-drawn sketches that bring life to your artistic vision.</p>
                        <button class="product-btn" onclick="window.location='<?php echo e(route('Sketches')); ?>'" style="text-decoration: none;">Shop Now</button>
                    </div>
                </div>

                <!-- Product 4 -->
                <div class="product-card">
                    <img src="<?php echo e(asset('images/mug.jpg')); ?>" alt="Mug Printing">
                    <div class="product-info">
                        <h3>Mug Printing</h3>
                        <p>Custom printed mugs, perfect for gifts and branding.</p>
                        <button class="product-btn" onclick="window.location='<?php echo e(route('MugPrinting')); ?>'" style="text-decoration: none;">Shop Now</button>
                    </div>
                </div>
            </div>
            ...
            <div class="show-more-container">
                <a href="<?php echo e(route('products')); ?>" class="show-more-btn">Show More</a>
            </div>
        </section>
        ...
        <section class="video-banner">
            ...
            <video autoplay muted loop playsinline class="video-bg">
                <source src="<?php echo e(asset('images/304pIkbEsTRm8.mp4_10s.mp4 ')); ?>" type="video/mp4">
            ...
            <div class="about-container">
                ...
                <div class="about-row">
                    <div class="about-image">
                        <img src="<?php echo e(asset('images/manwithcam.jpg')); ?>" alt="Creative Work">
                    </div>
                ...
                <div class="about-row">
                    ...
                    <div class="about-image">
                        <img src="<?php echo e(asset('images/cam.jpg')); ?>" alt="Innovation">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="carousel-container">
                ...
                <div class="carousel-frame">
                    <div class="carousel-track" id="carousel-track">
                        ...
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/28.jpg')); ?>" alt="28" /></div>
                        <div class="carousel-item"><img src="<?php echo e(asset('images/Gallery/29.jpg')); ?>" alt="29" /></div>
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/30.jpg')); ?>" alt="30" />
                        </div>

                        <!-- Actual 30 Images -->
                        <!-- Repeat up to 30 images -->
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/22.jpg')); ?>" alt="1" />
                        </div>
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/10.jpg')); ?>" alt="2" />
                        </div>
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/16.jpg')); ?>" alt="3" />
                        </div>
                        <!-- ... -->
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/30.jpg')); ?>" alt="30" />
                        </div>
                        ...
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/6.jpg')); ?>" alt="1-clone" />
                        </div>
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/6.jpg')); ?>" alt="2-clone" />
                        </div>
                        <div class="carousel-item"><img src=" <?php echo e(asset('images/Gallery/6.jpg')); ?>" alt="3-clone" />
                        </div>
                    </div>
                </div>
        ...
        <section class="blog-section">
            ...
            <div class="blog-container">
                ...
                <a href="blog-details.html?id=1" class="blog-card">
                    <img src=" <?php echo e(asset('images/wed.jpg')); ?>" alt="Wedding Highlight">
                ...
                <a href="blog-details.html?id=2" class="blog-card">
                    <img src="<?php echo e(asset('images/evn.jpg')); ?>" alt="Event Setup">
                    <div class="blog-content">
                ...
                <a href="blog-details.html?id=3" class="blog-card">
                    <img src="<?php echo e(asset('images/bab.jpg')); ?>" alt="Baby Photoshoot">
                    <div class="blog-content">
            ...
            <div class="see-more-container">
                <a href="<?php echo e(route('blog')); ?>" class="see-more-btn">See More</a>
            </div>
        </section>
...
<form id="contactForm" class="contact-form" action="<?php echo e(route('contact.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mhdsh\OneDrive\Documents\GitHub\Yarl-Creators\YarlCreators\resources\views/index.blade.php ENDPATH**/ ?>