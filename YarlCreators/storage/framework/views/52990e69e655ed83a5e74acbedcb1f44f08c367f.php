...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/ScrollToTop.css')); ?>" />
...
<section class="stats-section" id="stats">
    ...
    <section class="team-section">
        ...
        <div class="team-container">
            <div class="team-member">
                <img src="<?php echo e(asset('admin_assets/img/Profile/m1.jpg')); ?>" alt="Team Member 1" />
                <h3>Vimitha Jeyaraj</h3>
                <p>Founder & Creative Director</p>
            </div>
            <div class="team-member">
                <img src="<?php echo e(asset('admin_assets/img/Profile/m2.jpg')); ?>" alt="Team Member 2" />
                <h3>Gokulan Raj</h3>
                <p>Lead Videographer</p>
            </div>
            <div class="team-member">
                <img src="<?php echo e(asset('admin_assets/img/Profile/f1.jpg')); ?>" alt="Team Member 3" />
                <h3>Nivetha K.</h3>
                <p>Photographer & Editor</p>
            </div>
            <div class="team-member">
                <img src="<?php echo e(asset('admin_assets/img/Profile/m3.jpg')); ?>" alt="Team Member 4" />
                <h3>Sajith S.</h3>
        ...
        <div class="testimonial-slider">
            <div class="testimonial-track">
                <div class="testimonial-card">
                    <img src="<?php echo e(asset('admin_assets/img/Profile/f1.jpg')); ?>" alt="Client" class="client-img" />
                ...
                <div class="testimonial-card">
                    <img src="<?php echo e(asset('admin_assets/img/Profile/m1.jpg')); ?>" alt="Client" class="client-img" />
                ...
                <div class="testimonial-card">
                    <img src="<?php echo e(asset('admin_assets/img/Profile/m3.jpg')); ?>" alt="Client" class="client-img" />
                ...
                <div class="testimonial-card">
                    <img src="<?php echo e(asset('admin_assets/img/Profile/m2.jpg')); ?>" alt="Client" class="client-img" />
    ...
    <script src="<?php echo e(asset('js/script.css')); ?>"></script>
...
<?php /**PATH C:\Users\mhdsh\OneDrive\Documents\GitHub\Yarl-Creators\YarlCreators\resources\views/user/about.blade.php ENDPATH**/ ?>