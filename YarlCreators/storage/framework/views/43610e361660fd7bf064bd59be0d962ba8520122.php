    ...
    <div class="auth-container">
        <div class="form-box">
            ...
            <form method="POST" action="<?php echo e(route('login.post')); ?>">
                ...
                <p class="switch-form">Don't have an account? <a href="<?php echo e(route('register')); ?>">Sign Up</a></p>
            </form>
        </div>
        ...
        <div class="form-box hidden">
            ...
            <form method="POST" action="">
                ...
                <p class="switch-form"><a href="<?php echo e(route('login')); ?>">Back to Sign In</a></p>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\Users\mhdsh\OneDrive\Documents\GitHub\Yarl-Creators\YarlCreators\resources\views/auth/login.blade.php ENDPATH**/ ?>