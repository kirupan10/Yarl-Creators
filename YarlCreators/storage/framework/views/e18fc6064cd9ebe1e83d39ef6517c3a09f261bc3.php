    ...
    <div class="auth-container">
        <div class="form-box">
            ...
            <form method="POST" action="<?php echo e(route('register.post')); ?>">
                ...
                <p class="switch-form">Already have an account? <a href="<?php echo e(route('login')); ?>">Sign In</a></p>
            </form>
        </div>
...
<?php /**PATH C:\Users\mhdsh\OneDrive\Documents\GitHub\Yarl-Creators\YarlCreators\resources\views/auth/signup.blade.php ENDPATH**/ ?>