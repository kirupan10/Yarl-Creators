...
<head>
    ...
    <link rel="stylesheet" href=" <?php echo e(asset('admin_assets/css/Dashboard.css')); ?>" />
...
<body>
    ...
    <nav class="sidebar">
        ...
        <a href="<?php echo e(route('logout')); ?>"><i class="fas fa-cog"></i> Logout</a>
    </nav>
    <!-- Main -->
    <main>
        <header>
...
<?php /**PATH C:\Users\mhdsh\OneDrive\Documents\GitHub\Yarl-Creators\YarlCreators\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>