...
<body>
    ...
    <section class="featured-products">
        ...
        <div class="product-container">
            ...
            <div class="product-card">
                <img src="<?php echo e(asset('images/Tripods.jpg')); ?>" alt="Tripods">
            ...
            <!-- Product 2 -->
            <div class="product-card">
                <img src=" <?php echo e(asset('images/bag.jpg')); ?>" alt="Photography Bags & Cases">
                <div class="product-info">
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="<?php echo e(asset('images/sdcard.jpg')); ?>" alt="SD Card">
                <div class="product-info">
            ...
            <!-- Product 4 -->
            <div class="product-card">
                <img src="<?php echo e(asset('images/battery.jpg')); ?>" alt="Batteries & Power">
                <div class="product-info">
    ...
    <section class="featured-products">
        ...
        <div class="product-container">
            <!-- Product 1 -->
            <div class="product-card">
                <img src="<?php echo e(asset('images/flowers1.jpg')); ?>" alt="Camera Accessory">
                <div class="product-info">
            ...
            <!-- Product 2 -->
            <div class="product-card">
                <img src=" <?php echo e(asset('images/portrait1.png')); ?>" alt="Painting Frame">
                <div class="product-info">
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="<?php echo e(asset('images/OIP.jpeg')); ?>" alt="Sketches">
                <div class="product-info">
            ...
            <!-- Product 4 -->
            <div class="product-card">
                <img src="<?php echo e(asset('images/pano.jpg')); ?>" alt="Mug Printing">
                <div class="product-info">
    ...
    <section class="featured-products">
        ...
        <div class="product-container">
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="<?php echo e(asset('images/SketchesFrame.png')); ?>" alt="Sketches">
                <div class="product-info">
                    <h3>Sketches</h3>
    ...
    <section class="featured-products">
        ...
        <div class="product-container">
            ...
            <!-- Product 2 -->
            <div class="product-card">
                <img src=" <?php echo e(asset('images/do.jpeg')); ?>" alt="Painting Frame">
                <div class="product-info">
            ...
            <!-- Product 4 -->
            <div class="product-card">
                <img src="<?php echo e(asset('images/coffee.jpg')); ?>" alt="Mug Printing">
                <div class="product-info">
            ...
            <div class="product-card">
                <img src="<?php echo e(asset('images/mag.jpeg')); ?>" alt="Mug Printing">
                <div class="product-info">
            ...
            <div class="product-card">
                <img src="<?php echo e(asset('images/trumler.png')); ?>" alt="Mug Printing">
                <div class="product-info">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mhdsh\OneDrive\Documents\GitHub\Yarl-Creators\YarlCreators\resources\views/products.blade.php ENDPATH**/ ?>